...
public class ScriptComponentTestSuccessful {
	...
	public static void initTestContextTest() {
		...
		component = new ScriptComponent(context);
		component.getProperties().put("EXPRESSION", "ctx.setVariable('VARIABLE', 'VALOR')" );
		component.init();
	}
	...
	public void TestJSONSelector() {
		...
		try {
			...
			assertEquals("VALOR", context.getVariable("VARIABLE"));
